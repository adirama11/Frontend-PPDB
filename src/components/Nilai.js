          ...
          <div class="card shadow mb-4 ">
            <div class="card-header py-3 text-center">
              <h6 class="m-0 font-weight-bold text-primary">
                Data Nilai dan Rangking Peserta
              </h6>
            </div>
            <div class="card-body">
              ...
              <table class="table table-bordered table-succes mx-auto">
                ...
                {users.map((user, index) => (
                        ...
                        <th scope="col">{user.id_ujian}</th>
                        <th scope="col">{user.nilai}</th>
                        <th scope="col">{user.rangking}</th>
                        <th scope="col">
                          <Link to={``} className="btn btn-warning ms-3 me-3">Edit</Link >
                          <Link onClick={() => deleteData(user.id_pengumuman)} className="btn btn-danger mx-auto">Delete</Link >
                        </th>
                      </tr>
                      ))}
                </tbody>
